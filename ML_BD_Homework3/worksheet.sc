...
val ones = DenseMatrix.ones[Double](train.rows, 1)
val xTrain = DenseMatrix.horzcat(ones, train)
val ones = DenseMatrix.ones[Double](test.rows, 1)
val xTest = DenseMatrix.horzcat(ones, test)
...
val mse = new PrintWriter(new File("mse.txt" ))
